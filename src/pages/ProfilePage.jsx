    ...
    <View style={styles.mainContainer}>
      ...
      <ScrollView contentContainerStyle={styles.profileScrollContent} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.profileSubtitle}>
          {isAdmin ? 'Administrator account - manage the system.' : 'Manage your account and emergency settings.'}
        </Text>
        ...
        <View style={styles.profileCard}>
          ...
          {isAdmin ? (
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 4, marginBottom: 2 }}>
              <Ionicons name="shield-checkmark" size={14} color="#C68A17" style={{ marginRight: 4 }} />
              <Text style={{ fontSize: 13, color: '#C68A17', fontWeight: '700' }}>Administrator</Text>
            </View>
          ) : null}
        ...
        <View style={styles.profileMenu}>
          ...
          {isAdmin ? (
            <>
              <TouchableOpacity style={styles.profileActionRow} onPress={() => navigation.navigate('AdminDashboard')}>
                <View style={styles.profileIconWrap}>
                  <Ionicons name="grid-outline" size={18} color="#2C3E50" />
                </View>
                <Text style={styles.profileActionText}>Admin Dashboard</Text>
                <Ionicons name="chevron-forward" size={18} color="#8A96A3" />
              </TouchableOpacity>

              <TouchableOpacity style={styles.profileActionRow} onPress={() => navigation.navigate('AdminReports')}>
                <View style={styles.profileIconWrap}>
                  <Ionicons name="document-text-outline" size={18} color="#2C3E50" />
                </View>
                <Text style={styles.profileActionText}>Manage Reports</Text>
                <Ionicons name="chevron-forward" size={18} color="#8A96A3" />
              </TouchableOpacity>

              <TouchableOpacity style={styles.profileActionRow} onPress={() => navigation.navigate('AdminUsers')}>
                <View style={styles.profileIconWrap}>
                  <Ionicons name="people-outline" size={18} color="#2C3E50" />
                </View>
